...
## Structured SEO Audit Framework

> *Adapted from Anthropic's [knowledge-work-plugins/marketing/seo-audit](https://github.com/anthropics/anthropic-cookbook/tree/main/misc/knowledge-work-plugins/marketing/skills/seo-audit) skill.*

When running a full SEO audit, follow this structured workflow to ensure comprehensive coverage. This framework complements the existing orchestration logic by providing a stakeholder-ready audit process.

### Audit Workflow

1. **Keyword Research** — Research keywords related to the domain or topic. For each opportunity, assess:
   ...
   - **Keyword difficulty** — competitive assessment (easy, moderate, hard)
   - **Long-tail opportunities** — specific, lower-competition phrases with clear intent
   - **Question-based keywords** — "how to", "what is", "why does" queries mirroring People Also Ask results

2. **On-Page SEO Audit** — For each key page (homepage, top landing pages, recent posts), evaluate:
   - Title tags (unique, 50–60 chars, includes target keyword)
   - Meta descriptions (compelling, 150–160 chars, includes CTA)
   - H1 tags (exactly one per page, includes primary keyword)
   - H2/H3 structure (logical hierarchy, secondary keywords where natural)
   - Keyword usage in first 100 words, natural throughout, no stuffing
   - Internal linking (related content linked, orphan pages identified, descriptive anchor text)
   - Image alt text (descriptive, keywords where relevant)
   - URL structure (clean, readable, keyword-inclusive)

3. **Content Gap Analysis** — Identify missing content:
   - Competitor topic coverage gaps
   - Content freshness (pages not updated in 12+ months)
   - Thin content (under 300 words for informational queries)
   - Missing content types (guides, comparison pages, glossaries, tools, templates)
   - Funnel gaps (awareness, consideration, decision stages)
   - Topic cluster opportunities (pillar pages with supporting content)

4. **Technical SEO Checklist** — Evaluate technical foundations:
   - Page speed and likely bottlenecks
   - Mobile-friendliness (responsive design, tap targets, viewport)
   - Structured data opportunities (FAQ, HowTo, Product, Article, Organization, Breadcrumb)
   - Crawlability (robots.txt, XML sitemaps, canonical tags, noindex/nofollow)
...
5. **Competitor SEO Comparison** — For each competitor, compare:
   - Keyword overlap and gaps
   - Domain authority signals (backlink profiles, referring domains)
   - Content depth (average length, coverage breadth, publishing frequency)
   - SERP feature ownership (featured snippets, PAA, image packs, knowledge panels)
...
When categorizing keywords, classify by search intent to inform content strategy:

| Intent Type | Description | Content Strategy | Examples |
|-------------|-------------|------------------|----------|
| **Informational** | User wants to learn or understand | Blog posts, guides, tutorials, FAQs | "what is SEO", "how to improve page speed" |
| **Navigational** | User looking for a specific site/page | Ensure brand pages rank for brand terms | "Google Search Console", "Ahrefs login" |
| **Commercial** | User researching before purchase | Comparison pages, reviews, best-of lists | "best SEO tools 2026", "Ahrefs vs Semrush" |
| **Transactional** | User ready to take action/purchase | Landing pages, product pages, pricing | "buy SEO audit tool", "SEMrush pricing" |

### Intent Signals to Watch For
- **Informational**: "how to", "what is", "why does", "guide", "tutorial", "examples"
- **Commercial**: "best", "top", "review", "comparison", "vs", "alternative"
- **Transactional**: "buy", "pricing", "discount", "coupon", "free trial", "sign up"

Map each keyword opportunity to an intent type in the Keyword Opportunity Table to ensure content format matches user expectations.

---

## Quick Wins vs Strategic Investments

Prioritize all audit findings using this matrix to help stakeholders allocate resources effectively:

### Quick Wins (Do This Week)
Actions that take **under 2 hours** and have **immediate impact**:

| Action | Expected Impact | Typical Effort |
|--------|----------------|----------------|
| Fix missing/duplicate title tags | High | 30 min per page |
| Add meta descriptions to key pages | Medium | 15 min per page |
| Fix broken internal links (404s) | High | 1–2 hours |
| Add alt text to images | Medium | 30 min per page |
| Fix redirect chains (3+ hops) | Medium | 1 hour |
| Add missing canonical tags | High | 30 min |
| Fix mixed content (HTTP on HTTPS) | Medium | 1 hour |

### Strategic Investments (Plan for This Quarter)
Actions requiring **more effort** but driving **long-term growth**:

| Action | Expected Impact | Typical Effort | Dependencies |
|--------|----------------|----------------|--------------|
| Build topic cluster (pillar + supporting) | High | 2–4 weeks | Content team, keyword research |
| Create competitor comparison pages | High | 1–2 weeks per page | Competitor analysis |
| Implement structured data site-wide | Medium | 1–2 weeks | Developer support |
| Launch link-building campaign | High | Ongoing | Outreach resources |
| Overhaul site architecture/navigation | High | 2–4 weeks | UX/Dev team |
| Create content calendar from gap analysis | Medium | 1 week setup | Editorial resources |
| Improve Core Web Vitals scores | Medium–High | 2–4 weeks | Developer support |

### Prioritization Scoring

For each recommendation, assign:
- **Impact**: High / Medium / Low — effect on rankings, traffic, or conversions
- **Effort**: Quick (<2 hrs) / Moderate (half day) / Substantial (multi-day)
- **Priority** = Impact ÷ Effort — highest priority items have high impact and low effort

Always present the action plan sorted by priority score, with quick wins first.
